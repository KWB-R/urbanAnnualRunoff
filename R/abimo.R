...
#' @param subcatchmSPobject Spatial dataset containing subcatchment polygons (ABIMO Blockteilflächen) (sp object type, R package sp).
#' @param overlayName Name of output overlay object.
#' @param subcatchmNamesCol Name of column in the attribute table of subcatchmSPobject that contains the subcatchment identifiers. This
