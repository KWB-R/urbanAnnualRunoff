...
#' further columns.
#' @param groundTruthValues List with key value pairs giving a numerical ID for
#' each surface type (default: list('roof' = 1, 'street' = 2, 'pervious' = 3,
#' shadow' = 4, 'water' = 5))
...
#' @param mtryGrd Number of variables available for splitting at each tree node.
...
#' @param ntreeGrd Number of trees to grow. In the random forests literature, this
...
#' (default: 3)
#' @param nodesize Minimum size of terminal nodes. (not included
#' in grid search), (default: 3) (from randomForest)
...
#' @param modelName Name of fitted random forest model saved by buildClassMod
