...
#abimo@data$PROBAU <- (1-100*(90.42-15.2)/100)*abimo@data$PROBAU # combi_high
# 50 % green-roof: with_berm_intensive_no-drainmat
#abimo@data$PROBAU <- (1-50*(90.42-15.2)/100)*abimo@data$PROBAU # combi_medium
# 25 % green-roof: with_berm_intensive_no-drainmat
#abimo@data$PROBAU <- (1-25*(90.42-15.2)/100)*abimo@data$PROBAU 
# 100 % green-roof: with_berm_extensive_no-drainmat
#abimo@data$PROBAU <- (1-100*(72.6-15.2)/100)*abimo@data$PROBAU
# 50 % green-roof: with_berm_extensive_no-drainmat
#abimo@data$PROBAU <- (1-50*(72.6-15.2)/100)*abimo@data$PROBAU
# 25 % green-roof: with_berm_extensive_no-drainmat
#abimo@data$PROBAU <- (1-25*(72.6-15.2)/100)*abimo@data$PROBAU # combi_low
