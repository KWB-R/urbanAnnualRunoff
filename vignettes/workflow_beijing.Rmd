...
#abimo@data$PROBAU <- (1-(0.9042-0.152))*abimo@data$PROBAU
# 50 % green-roof: with_berm_intensive_no-drainmat
#abimo@data$PROBAU <- (1-(0.9042-0.152)/2)*abimo@data$PROBAU
# 100 % green-roof: with_berm_extensive_no-drainmat
#abimo@data$PROBAU <- (1-(0.726-0.152))*abimo@data$PROBAU
# 50 % green-roof: with_berm_extensive_no-drainmat
#abimo@data$PROBAU <- (1-(0.726-0.152)/2)*abimo@data$PROBAU
...
#abimo@data$PROVGU <- (1-100*(0.572-0.152)/50)*abimo@data$PROVGU
#  50 % permeable pavements: 180mm.per.hour_no-drainage
#abimo@data$PROVGU <- (1-50*(0.572-0.152)/50)*abimo@data$PROVGU
