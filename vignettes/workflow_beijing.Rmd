...
tibble::tibble(
  ...
  rainfall_cbm = sum(as.numeric(abimo_inpout$FLAECHE)*as.numeric(abimo_inpout$REGENJA)/1000),
  runoff_cbm = sum(as.numeric(abimo_inpout$FLAECHE)*as.numeric(abimo_inpout$ROW)/1000),
  infiltration_cbm = sum(as.numeric(abimo_inpout$FLAECHE)*as.numeric(abimo_inpout$RI)/1000),  
  evapotrans_cbm = sum(as.numeric(abimo_inpout$FLAECHE)*as.numeric(abimo_inpout$VERDUNSTUN)/1000)
)
}
...
scenario_results_beijing <- dplyr::bind_rows(scenario_results_list) %>% 
  dplyr::mutate(vrr = 1 - .data$runoff_cbm/.data$rainfall_cbm)

#usethis::use_data(scenario_results_beijing)
